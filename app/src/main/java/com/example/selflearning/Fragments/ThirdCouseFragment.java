...
public class ThirdCouseFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =   inflater.inflate(R.layout.fragment_third_couse, container, false);
        init(view);
        getDataFromDB(3,1);
        setOnClickItem();
        return view;
    ...
    private void init(View view) {
        ...
        semesterName = view.findViewById(R.id.nameSemesterThirdCourse);

        //init for list
        listView = view.findViewById(R.id.listThirdCourse);
