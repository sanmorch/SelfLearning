...
public class FourthCourseFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fourth_course, container, false);
        init(view);
        getDataFromDB(4,1);
        setOnClickItem();
        return view;
    ...
    private void init(View view) {
        ...
        semesterName = view.findViewById(R.id.nameSemesterFourthCourse);

        //init for list
        listView = view.findViewById(R.id.listFourthCourse);
